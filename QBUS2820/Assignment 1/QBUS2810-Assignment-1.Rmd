...
This project aims to develop several predictive models salary for NBA basketball players. Three models including , k-nearest neignbour model, a linear regression model and a lasso regression model are involved. Root mean square error is used as the performance metric to select models with the best performance regarding predictions of NBA players' salaries.
