...
This project aims to develop several predictive models salary for NBA
...
Root mean square error is used as the performance metric to select
models with the best performance regarding predictions of NBA players'
salaries.
