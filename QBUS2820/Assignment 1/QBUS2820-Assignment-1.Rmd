...
After selecting and preprocessing the potential features and response, following the 80/20 rule, the `NBA_train` dataset is splitted into the training set and validation set. The training set is used to develop models while the validation set helps to select models developed. 
