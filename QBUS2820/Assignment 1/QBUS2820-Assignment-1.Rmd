...
There are 14 numeric variables in the `Boston housing` dataset. As shown in Figure \ref{fig:missHouse}, the dataset is 100% complete without missing values. **Outliers**
...
From Figure \ref{fig:corrHouse} and Table \ref{table:corrTab}, "lstat", "rm" and "ptrtio" have relatively strong linear relationship with "medv".
