...
Lasso with automated feature selection and regularization could be
better-suited for the data compared to regular linear regression.
...
neighbour regression observe pattern in the data without fix function.
