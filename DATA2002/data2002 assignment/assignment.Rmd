...
The properties of the survey are discussesed in this report. Although the data is a random sample of DATA2002 students, non-response bias, measurement bias and voluntary response bias can occur due to the imperfact survey design, resulting in potentially biased variables in the data.
